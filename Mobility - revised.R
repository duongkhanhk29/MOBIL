...
Fig_2 = ggarrange(plot_scatter("expansion", "mobility"),
...
Fig_4 = ggarrange(plot_violin("mom", "mobility"),
          plot_violin("daughter", "mobility"), 
          ncol = 2, nrow = 1)

Fig_1 = ggarrange(ggarrange(plot_violin("developing", "mobility"),
...
Fig_3 = plot_results(Q1)
Fig_5 = plot_results(Q2_mom)
Fig_6 = plot_results(Q2_dau)
